...
project_config = {
	...
	CNN_PARAMS: {
		DROP0: 0.5,
		DROP1: 0.2, # TODO Modell erstellne
		ACTIVATION: ACTIVATION_SILU, # TODO auswahl
		OPTIMIZER: OPTIMIZER_SGD, # TODO ass auswahl
		LOSS_FUNCTION: LOSS_FOCAL_LOSS, # TODO auswahl
		LOSS_FUNCTION_PARAMETER_1: 2.0, # Focal Loss: gamma, 
		SHEDULER: SHEDULER_COSINE, # SHEDULER_COSINE, SHEDULER_STEP, SHEDULER_PLATEAU, None
		...
		EARLY_STOPPING_ENABLED: True, # TODO early stopping
