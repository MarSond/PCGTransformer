...
class DataAnalysis:
	...
	def make_singlefile_plot(self, raw_audio, filtered_audio, full_audio, sgram_raw, sgram_filtered, sgram_augmented, meta_row, audio_file_name, ax=None):
...
def single():
	analysis = DataAnalysis(const.PHYSIONET_2022)
	analysis.plot_signal_statistics(num_samples=3, offset=80, show=True, fig_file_name=None)
