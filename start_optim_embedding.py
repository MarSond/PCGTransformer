...
if __name__ == "__main__":
	# configs = [
	#     {
	# 		TRAIN_DATASET: PHYSIONET_2016, CHUNK_DURATION: 9.0,
	# 		CHUNK_METHOD: CHUNK_METHOD_FIXED,
	# 		LOAD_EMBEDDINGS_FROM_RUN_NAME: "2024-09-17_15-50-38_2016_fix_optim_audio"
	# 	},
	#     {
	# 		TRAIN_DATASET: PHYSIONET_2022, CHUNK_DURATION: 5.0,
	# 		CHUNK_METHOD: CHUNK_METHOD_FIXED,
	# 		LOAD_EMBEDDINGS_FROM_RUN_NAME: "2024-09-17_15-54-52_2022_fix_optim_audio"
	# 	},
	#     {
	...
	# 		LOAD_EMBEDDINGS_FROM_RUN_NAME: "2024-09-17_15-58-19_2022_cycle_optim_audio"
	# 	},
	# ]
	configs = [
		{
	...
	for config in configs:
		start_optimization(config, n_trials=6)
